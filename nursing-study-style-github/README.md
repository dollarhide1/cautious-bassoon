...
This repo contains a marketing **landing page** (for GitHub Pages / Netlify) and the **product** itself (sold on Payhip for **$7.99 one-time**).
...
3. **Price:** `7.99` · set currency to USD · one-time (Payhip products are one-time by default).
